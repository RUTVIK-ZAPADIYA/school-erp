      ...
      <div class="auth-card auth-sm">
        ...
        <form id="resetPasswordForm" method="POST" action="" novalidate>
          ...
          <div class="input-group-custom">
            <input type="password" class="form-control" id="password" name="password" placeholder="New Password" required minlength="8" data-validation="required,min">
            <i class="fas fa-lock input-icon"></i>
            <i class="fas fa-eye password-toggle" id="togglePassword"></i>
          </div>

          <div class="input-group-custom">
            <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm Password" required minlength="8" data-validation="required,min">
            <i class="fas fa-lock input-icon"></i>
        ...
        <a href="login.php" class="btn btn-primary w-100" style="border-radius: 8px; font-weight: 700; padding: 12px;">

...
<head>
  ...
  <style>
    ...
    .about-card h3 { color: #2c3e50; margin-bottom: 20px; font-weight: 700; }
    .about-card p { color: #7f8c8d; line-height: 1.8; }
    .team-member { text-align: center; margin-bottom: 30px; }
    .team-avatar { width: 120px; height: 120px; background: #3498db; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 15px; }
    .team-avatar i { font-size: 50px; color: white; }
    .team-member h5 { color: #2c3e50; font-weight: 600; margin-bottom: 5px; }
  ...
  <div class="content-section">
    <div class="container">
      <div class="about-card">
        <h3><i class="fas fa-bullseye" style="color: #3498db;"></i> Our Mission</h3>
      ...
      <div class="about-card">
        <h3><i class="fas fa-eye" style="color: #3498db;"></i> Our Vision</h3>
      ...
      <div class="about-card">
        <h3><i class="fas fa-star" style="color: #3498db;"></i> Why Choose Us</h3>
      ...
      <h2 style="text-align: center; color: #2c3e50; font-weight: 700; margin: 60px 0 40px;">Our Team</h2>
      <div class="row">
        <div class="col-md-3">
